...
#include <string.h> /* Para la cadena de puntitos */
...
void print_board(char board[BOARD_SIZE][BOARD_SIZE])
{
    ...
    // Creamos e Inicializamos el arreglo con caracteres nulos
    char *puntitos = malloc(sizeof(char) * 19 * BOARD_SIZE);
    memset(puntitos, '\0', sizeof(char) * 19 * BOARD_SIZE);

    char repetir[] = "..................";
    int i;
    for (i = 0; i < BOARD_SIZE; i++) {
        strcat(puntitos, repetir);
    }
    ...
    // Limpiamos el arreglo fila utilizando memset()
    memset(puntitos, 0, sizeof(char) * 19 * BOARD_SIZE);
}
...
int main(void)
{
    ...
    {
        print_board(board);
        printf("\nTurno %c - Elija una posición del 0 al %d.\n ",
               turn, CELL_MAX);
